                    ...
                    <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                        <li ng-repeat="module in modulesList" class="">
                            ...
                            <a href="" class="link-dark d-inline-flex text-decoration-none rounded"
                               ng-class="{'text-bg-primary':module==activeModule}" ng-click="selectModule(module)">{{module}}</a>
                        </li>
                    </ul>
        ...
        <div style="width: 80%;margin-top: 20px;">
            ...
            <table ng-show="!loading" class="table table-striped">
                ...
                <tr ng-repeat="migration in migrationList">
                    ...
                    <td>
                        <button ng-if="!migration.confirmed" type="button" class="btn btn-success btn-sm" ng-click="upMigration(migration.className)">Применить
                        </button>
                        <button ng-if="migration.confirmed" type="button" class="btn btn-danger btn-sm" ng-click="downMigration(migration.className)">Откатить
                        </button>
                    </td>
                </tr>
