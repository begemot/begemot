...
app.controller('FormController', ['$http', '$scope', function($http, $scope) {
    ...
    $scope.test = 111;
    $scope.inputData = [{
            "Название": "Названиие вездехода 1",
        ...
        {
            "Название": "Названиие вездехода 2",
            "Характеристика 1": "Значение характеристики 1",
            "Характеристика 1": "Значение характеристики 1",
            "Характеристика 2": "Значение характеристики 2",
            "Характеристика 3": "Значение характеристики 3"
...
<div class="container" ng-app="myApp" ng-controller="FormController as ctrl">
    <h2>Массовый ввод данных в схемы, группировка по "Название"</h2>
    ...
    <div class="container mt-5">
        <div class="row mt-5">
            ...
            <json-table input-data="inputData" output-data="outputData" send-data-url='/schema/Manage/massDataProcess'
                additional-data-for-send='selectedItem' mt='false'>
            </json-table>
