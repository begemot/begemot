angular.module('pictureBox').controller('massResize', [
	'$scope',
	'$http',
	'galleryControl',
	'values',
	function ($scope, $http, galleryControl, values) {
		...
		$scope.getAllIds = function () {
			$http
				.get(
					'/pictureBox/api/GetAllIds/gallery/' + $scope.settingsForm.galleryId
				)
