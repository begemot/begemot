...
<div ng-app="myApp" ng-controller="myCtrl">
    ...
    <div class="container mt-5">
        <div class="row mt-5">
            <div>
                <button class="btn btn-primary btn-sm" ng-click="submitData()" ng-if="attachButtonVisible">Прикрепить</button>
                <cat-item-select selected-items="selectedItems" on-select-change="onSelectAndUnselect(items)" selected-items-view='1' show-cats='true'>
                    <div>{{item.name}}</div>
    ...
    <div class="container mt-5">
        ...
        <div class="btn-group" role="group" aria-label="Status Switcher">
            <input type="radio" class="btn-check" name="status" id="status_stock" autocomplete="off" ng-click='moveToStandartCat("stock")'>
            <label class="btn btn-outline-success" for="status_stock">Stock</label>

            <input type="radio" class="btn-check" name="status" id="status_catalog" autocomplete="off" ng-click='moveToStandartCat("catalog")'>
            <label class="btn btn-outline-primary" for="status_catalog">Catalog</label>

            <input type="radio" class="btn-check" name="status" id="status_sold" autocomplete="off" ng-click='moveToStandartCat("sold")'>
            <label class="btn btn-outline-danger" for="status_sold">Sold</label>

            <input type="radio" class="btn-check" name="status" id="status_archive" autocomplete="off" ng-click='moveToStandartCat("archive")'>
            <label class="btn btn-outline-secondary" for="status_archive">Archive</label>

            <input type="radio" class="btn-check" name="status" id="status_clear" autocomplete="off" ng-click='moveToStandartCat("clear")'>
